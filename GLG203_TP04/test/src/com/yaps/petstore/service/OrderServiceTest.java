...
public final class OrderServiceTest extends AbstractTestCase {
    ...
    private String createOrder(final String id) throws CreateException, CheckException {
        ...
        final Item item = new Item(itemId, "name" + itemId, 12345, product);
        ...
        final OrderLine oi1 = new OrderLine(null, 123, item.getUnitCost(), order, item);
        final OrderLine oi2 = new OrderLine(null, 456, item.getUnitCost(), order, item);
    ...
    private void checkOrder(final Order order, final String id) {
        ...
        final OrderLine firstOrderLine = (OrderLine)order.getOrderLines().iterator().next();
        assertEquals("first order unit cost", 12345.0, firstOrderLine.getUnitCost(), 0.01);
    }
