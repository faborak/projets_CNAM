...
public final class CatalogServiceTest extends AbstractTestCase {
    ...
    public void testServiceUpdateCategory() throws Exception {
        ...
        updateCategory(category, updatePattern);
...
/**
    ...
    public void testServiceCreateProductWithInvalidCategory() throws Exception {
        ...
        try {
            product = new Product(id, "name" + id, "description" + id, null);
            service.createProduct(product);
        ...
        try {
            product = new Product(id, "name" + id, "description" + id, new Category());
        ...
        try {
            product = new Product(null, "name" + id, "description" + id, null);
            service.createProduct(product);
    ...
    public void testServiceUpdateProduct() throws Exception {
        ...
        // Updates the object with new values
        updateProduct(product, updatePattern);
   ...
   /**
    ...
    public void testServiceCreateItemWithInvalidProduct() throws Exception {
        ...
        // Creates an object with no object linked
        try {
            item = new Item(id, "name" + id, 12, null);
            service.createItem(item);
            fail("Object with no object linked should not be created");
        } catch (CheckException e) {
        }
        ...
        // Creates an object with an unknown linked object
        try {
            final Product product = new Product(null, "name" + id, "description" + id, null);
            item = new Item(id, "name" + id, 12, product);
            service.createItem(item);
            fail("Object with an unknown object linked should not be created");
        } catch (CreateException e) {
        }
...
/**
    ...
    private Category findCategory(final String id) throws FinderException, CheckException {
        final Category category = getCatalogService().findCategory(id);
        return category;
    }
    ...
    private void updateCategory(final Category category, final String updatePattern) throws UpdateException, CheckException {
        category.setName("name" + updatePattern);
        category.setDescription("description" + updatePattern);
    ...
    private Product findProduct(final String id) throws FinderException, CheckException {
        final Product product = getCatalogService().findProduct(id);
        return product;
    }
    ...
    private void createProduct(final String id) throws CreateException, CheckException {
        ...
        final Category category = new Category(categoryId, "name" + categoryId, "description" + categoryId);
        getCatalogService().createCategory(category);
        // Create Product
    ...
    private void updateProduct(final Product product, final String updatePattern) throws UpdateException, CheckException, CreateException {
        // Create Category
    	final String categoryId = getCatalogService().getUniqueId("Category");
        final Category category = new Category(categoryId, "name" + categoryId, "description" + categoryId);
        getCatalogService().createCategory(category);
        // Update Product with new category
        product.setName("name" + updatePattern);
        product.setDescription("description" + updatePattern);
    ...
    private void deleteProduct(final String id) throws RemoveException, CheckException, FinderException {
    	...
    	final Product product = getCatalogService().findProduct(productId);
    ...
    private Item findItem(final String id) throws FinderException, CheckException {
        final Item item = getCatalogService().findItem(id);
        return item;
    }
    ...
    private void createItem(final String id) throws CreateException, CheckException {
        ...
        final Product product = new Product(productId, "name" + productId, "description" + productId, category);
        getCatalogService().createProduct(product);
        // Create Item
        final Item item = new Item(id, "name" + id, Double.parseDouble(id), product);
        getCatalogService().createItem(item);
    }

    // Creates a category, a product and updates the item with this new product
    private void updateItem(final Item item, final String updatePattern) throws UpdateException, CheckException, CreateException {
        // Create Category
    	final String categoryId = getCatalogService().getUniqueId("Category");
        final Category category = new Category(categoryId, "name" + categoryId, "description" + categoryId);
        getCatalogService().createCategory(category);
        ...
        getCatalogService().createProduct(product);
        // Updates the item
        item.setName("name" + updatePattern);
    ...
    private String getUniqueId(final String domainClassName) {
