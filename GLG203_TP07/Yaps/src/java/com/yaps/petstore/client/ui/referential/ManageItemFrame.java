...
public final class ManageItemFrame extends AbstractFrame implements BarEventListener {
    ...
    public void delete(final DeleteEvent evt) {
        ...
        try {
            // Deletes the item
            new CatalogDelegateFactory().createCatalogDelegate().deleteItem(textId.getText());
    ...
    public void find(final FindEvent evt) {
        ...
        try {
            // Finds the item
            final ItemDTO itemDTO = new CatalogDelegateFactory().createCatalogDelegate().findItem(textId.getText());
