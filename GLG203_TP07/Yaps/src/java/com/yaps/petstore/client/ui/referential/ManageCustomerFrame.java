...
public final class ManageCustomerFrame extends AbstractFrame implements BarEventListener {
    ...
    public void delete(final DeleteEvent evt) {
        ...
        try {
            ...
            new CustomerDelegateFactory().createCustomerDelegate().deleteCustomer(textId.getText());
    ...
    public void find(final FindEvent evt) {
        ...
        try {
            // Finds the customer
            final CustomerDTO customerDTO = new CustomerDelegateFactory().createCustomerDelegate().findCustomer(textId.getText());
