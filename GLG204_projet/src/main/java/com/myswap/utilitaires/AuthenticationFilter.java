...
* Else, make an 401 HTTP Response.
*/
@Secured
@Provider
...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    @Override
    /**
     * Recup�re toutes les requ�tes au serveur, et les valides avant l'acc�s aux web services.
     */
    ...
    private void validateToken(String token) throws Exception {
    	...
    	if (userActivityPlusSevenMinutes.compareTo(new Date()) == -1){
    	    throw new Exception("Le user n'est plus authentifié");	
    	} else {
