...
CREATE TABLE IF NOT EXISTS `User` (
  ...
  `lastname` varchar(30) COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `Adress` (
  `id_user` int(11) NOT NULL,
  `street` varchar(30) COLLATE utf8_bin ,
  `state` varchar(30) COLLATE utf8_bin ,
  `zipcode` varchar(10) ,
  `city` varchar(30) 
...
INSERT INTO `Adress` (`id_user`, `street`, `state`, `zipcode`, `city`) VALUES
(1, '73 avenue de la république', 'Ile-de-France', 77184, 'Courbevoie'),
(2, 'Rue Saint-Martin', 'Ile-de-France', 77184, 'Paris 3'),
(3, 'Rue Conte', 'Ile-de-France', 77184, 'Paris 3'),
(4, '1 rue des mystères', 'Ile-de-France', 77184, 'Courbevoie'),
(5, '24 allée du temps qui passe', 'Ile-de-France', 77184, 'Emerainville');
...
(1, 1, 2, 'Ce type est super !', 5),
(2, 2, 3, 'Très cool ! Bon feeling', 4),
(3, 3, 4, 'Très désagréable.', 1),
(4, 4, 5, 'Non, défintiviement non.', 2),
(5, 5, 1, 'Top !.', 5);
...
(1, 'objet 1', '2015-01-25', '2015-05-25', 'super pin''s !', 1),
(2, 'objet 2', '2015-01-25', '2015-05-25', 'old school puzzle', 1),
(3, 'objet 3', '2015-01-25', '2015-05-25', 'déguisement de croisé', 1),
...
(1, 'Jussieu', 'serveur dans un café', 'Salut ! J''espère qu''on va faire des affaires ensemble!'),
...
CREATE TABLE IF NOT EXISTS `Picture` (
  ...
  `path` varchar(160) COLLATE utf8_bin NOT NULL
...
INSERT INTO `Picture` (`id_picture`,`path`) VALUES
(1, 'http://i.imgur.com/pqj02Tg.jpg'),
(2, 'http://i.imgur.com/DkSqY8d.jpg'),
(3, 'http://i.imgur.com/eigJydK.jpg'),
(4, 'http://i.imgur.com/YtigpwQ.jpg'),
(5, 'http://i.imgur.com/H2nQOo4.jpg'),
(6, 'http://i.imgur.com/kfGAXZM.jpg');
...
--
ALTER TABLE `Infos`
ADD CONSTRAINT `infos_idfk_1` FOREIGN KEY (`id_user`) REFERENCES `User` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
