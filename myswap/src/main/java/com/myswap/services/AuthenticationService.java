...
public class AuthenticationService {
    ...
    @Path("/authenticate")
    public Response authenticateUser(@FormParam("username") String mail, 
...
//    	    httpTransport, jsonFactory,CLIENT_ID, SECRET_ID ,"code", "postmessage").execute();
//    	 
...
//    	 
//    	Oauth2 oauth2 = new Oauth2.Builder(httpTransport, jsonFactory, credential).setApplicationName("MySwap").build();
