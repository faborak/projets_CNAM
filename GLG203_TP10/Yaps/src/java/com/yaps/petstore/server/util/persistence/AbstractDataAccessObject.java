...
public abstract class AbstractDataAccessObject implements DataAccessConstants {
    ...
    private static final String _sname = AbstractDataAccessObject.class.getName();
    private static final String _datasourceName = "jdbc/petstoreDS";
    ...
    public static void displaySqlException(final SQLException e) {
        ...
        Trace.severe(_sname, mname, "Error code  : " + e.getErrorCode());
        Trace.severe(_sname, mname, "SQL state   : " + e.getSQLState());
        Trace.severe(_sname, mname, "SQL message : " + e.getMessage());
        Trace.throwing(_sname, mname, e);
    }
    ...
    public static void displaySqlException(final String message, final SQLException e) {
        ...
        Trace.severe(_sname, mname, "Message     : " + message);
        Trace.severe(_sname, mname, "Error code  : " + e.getErrorCode());
        Trace.severe(_sname, mname, "SQL state   : " + e.getSQLState());
        Trace.severe(_sname, mname, "SQL message : " + e.getMessage());
        Trace.throwing(_sname, mname, e);
