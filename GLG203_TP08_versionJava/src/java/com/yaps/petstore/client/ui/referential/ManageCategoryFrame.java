...
public final class ManageCategoryFrame extends AbstractFrame implements BarEventListener {
    ...
    public void delete(final DeleteEvent evt) {
        ...
        try {
            ...
            new CatalogDelegateFactory().createCatalogDelegate().deleteCategory(textId.getText());
    ...
    public void find(final FindEvent evt) {
        ...
        try {
            // Finds the category
            final CategoryDTO categoryDTO = new CatalogDelegateFactory().createCatalogDelegate().findCategory(textId.getText());
