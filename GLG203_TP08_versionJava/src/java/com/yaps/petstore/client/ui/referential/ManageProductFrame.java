...
public final class ManageProductFrame extends AbstractFrame implements BarEventListener {
    ...
    public void delete(final DeleteEvent evt) {
        ...
        try {
            // Deletes the product
            new CatalogDelegateFactory().createCatalogDelegate().deleteProduct(textId.getText());
    ...
    public void find(final FindEvent evt) {
        ...
        try {
            // Finds the product
            final ProductDTO productDTO = new CatalogDelegateFactory().createCatalogDelegate().findProduct(textId.getText());
