...
<div id="header-wrapper">
	<div id="header">
		<div id="logo">
			<h1><a href="#">Projet : mines</a></h1>
		</div>
		<div id="menu">
			<ul>
				<li><a href="#" accesskey="1" title="">Homepage</a></li>
				<li><a href="http://orm.bdpedia.fr/intro.html" accesskey="2" title="">Cours NSY135</a></li>
				<li><a href="http://localhost/phpmyadmin/" accesskey="3" title="">PhpMyAdmin</a></li>
				<li><a href="http://orm.bdpedia.fr/projets.html" accesskey="4" title="">Sujet</a></li>
...
<div id="banner">
	<div class="img-border"> <a href="#"><img src="images/Image accueil exploitation minière.jpg" width="1120" height="300" alt="" /></a> </div>
</div>
<div id="wrapper">
	<div id="wide-content">
		<div>
			...
			<p class="button-style"><a href="#">Haut de page</a></p>
		</div>
	</div>
</div>
<div id="page-wrapper">
