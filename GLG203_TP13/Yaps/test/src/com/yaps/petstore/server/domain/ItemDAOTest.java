...
public final class ItemDAOTest extends AbstractTestCase {
    ...
    private void findItemSql(final String id) throws ObjectNotFoundException, SQLException {
        ...
        try {
            ...
            // Select a Row
            sql = "SELECT * FROM T_ITEM WHERE ID = '" + id + "' ";
    ...
    private int findAllItems(String productId) throws FinderException {
        try {
            return _dao.findAll(productId).size();
        } catch (ObjectNotFoundException e) {
            return 0;
        }
    }
