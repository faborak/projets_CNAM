...
public class WebTest extends AbstractTestCase {
    ...
    public void testWebCheckPages() {
        ...
        try {
            webConversation.getResponse(URL_PETSTORE + "/customers.jsp");
        } catch (Exception e) {
            fail("customers.jsp hasn't been found");
        }
    ...
    public void testWebCheckServlets() {
        ...
        try {
            webConversation.getResponse(URL_PETSTORE + "/findcustomers");
        } catch (Exception e) {
            fail("The FindCustomersServlet hasn't been found");
        }
