 ...
 */
public class FindCustomersServlet extends AbstractTestCase {
    ...
    public FindCustomersServlet(final String s) {
        super(s);
    }

    public static TestSuite suite() {
        return new TestSuite(FindCustomersServlet.class);
    }
     ...
     * This test tries to create an object with a invalid values.
     */
    public void testServletCreateCustomerWithAgeOutOfBounds() throws Exception {
        final int id = getPossibleUniqueIntId();
        try {
            createAgeOutOfBoundsCustomer(id);
            fail("Object with invalid year of birth should not be created");
        } catch (Exception e) {
        }
    }
     ...
     * This test tries to create an object with a invalid values.
     */
    public void testServletCreateCustomerWithInvalidAge() throws Exception {
        final int id = getPossibleUniqueIntId();
        createInvalidAgeCustomer(id, "XX200");
        createInvalidAgeCustomer(id, "Deux mille");
        }
    ...
    private void createCustomer(final int id) throws Exception {
        ...
        createCustomerForm.setParameter("creditCardExpiryDate", "10/18");
    ...
    private void createAgeOutOfBoundsCustomer(final int id) throws Exception {
        // Gets the create customer page Web Page
        WebResponse customerPage = signInCustomer(id);
        // ... and get the form
        WebForm createCustomerForm = customerPage.getFormWithName("customerForm");
        ...
        // Sets empty parameters to the web page
        createCustomerForm.setParameter("firstname", "Bill");
        createCustomerForm.setParameter("lastname", "Gates");
        createCustomerForm.setParameter("yearofbirth", "3000");
        // Submits the form
        createCustomerForm.submit();
        // If after clicking the submit button an error occurs,
        // the page title is 'YAPS Error'
    ...
    private void createInvalidAgeCustomer(final int id, String invalidInt) throws Exception {
        // Gets the create customer page Web Page
        WebResponse customerPage = signInCustomer(id);
        // ... and get the form
        WebForm createCustomerForm = customerPage.getFormWithName("customerForm");
        ...
        createCustomerForm.setParameter("firstname", "Bill");
        createCustomerForm.setParameter("lastname", "Gates");
        createCustomerForm.setParameter("yearofbirth", invalidInt);
        // Submits the form
        createCustomerForm.submit();
        // If after clicking the submit button an error occurs,
        // the page title is 'YAPS Error'
    ...
    private void checkCustomer(final Customer customer, final int id) {
        ...
        assertEquals("CreditCardExpiryDate", "10/18", customer.getCreditCardExpiryDate());
