...
public interface CustomerServiceRemote extends Remote {
    ...
    /**
     * This method return all the customers whose last name starts with lastNameFirstChars. It uses the CustomerDAO object
     * to get the data. It then transforms this collection of Customer object into a
     * collection of CustomerDTO and returns it.
     *
     * @param lastNameFirstChars
    ...
    /**
     * This method return all the customers whose age is in a given interval. It uses the CustomerDAO object
     * to get the data. It then transforms this collection of Customer object into a
     * collection of CustomerDTO and returns it.
     *
     * @param minAge
