...
<t:layout>
 <jsp:attribute name="premiere_bulle">
   <div>
	...
	<ul>
	<%-- 	<li><a href="${pageContext.request.contextPath}/Hibernate?action=LectureParCle">Lecture par cle</a></li> 
		<li><a href="${pageContext.request.contextPath}/Hibernate?action=RechercheHQLCriteria">Lecture par HQL/Criteria</a></li>  --%>
		
		La suite sur le controleur <a href="${pageContext.request.contextPath}/Requeteur">/Requeteur</a>.
